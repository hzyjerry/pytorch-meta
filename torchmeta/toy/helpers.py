...
from torchmeta.toy import Sinusoid, Harmonic, Behaviour
from torchmeta.transforms import ClassSplitter

def behaviour(inputs, shots, shuffle=True, test_shots=None, seed=None, **kwargs):
    """Helpber function to create behaviour dataset
    ...
    dataset = Behaviour(inputs, num_samples_per_task=shots + test_shots, **kwargs)
